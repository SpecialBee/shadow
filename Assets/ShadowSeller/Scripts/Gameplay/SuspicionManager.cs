...
namespace ShadowSeller.Core
{
    ...
    //   변화율(Rates): Dark=-6 / Shadow=0 / Lit=+8 / ExposedSight=+20 / ExposedClose=+20
    ...
    public class SuspicionManager : MonoBehaviour, ITickable
    {
        ...
        // Dark=0, Shadow=-6, Lit=+8, ExposedSight=+20, ExposedClose=+20
        private static readonly float[] Rates = { 0f, -6f, 8f, 20f, 20f };
